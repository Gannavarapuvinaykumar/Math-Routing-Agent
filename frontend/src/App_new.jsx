...
function App() {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch(`http://127.0.0.1:8000/api/agent_route?query=${encodeURIComponent(query)}`, {
        method: 'POST',
        headers: {
      ...
      <div style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{ color: '#7f8c8d', fontSize: '1.1em' }}>
            AI-powered math solver with knowledge base, web search, and human feedback
          </p>
        </div>
        ...
        {route && (
          <div style={{ 
            ...
            <span style={{ 
              ...
              📍 Source: {route === 'KB' ? '📚 Knowledge Base' : route === 'Web' ? '🌐 Web Search' : route === 'AI' ? '🤖 AI Model' : '👨‍🏫 Human Expert'}
            </span>
          </div>
        )}
        ...
        {showFeedback && (
          <div style={{ 
            ...
            {!feedbackSubmitted ? (
              <>
                <h3 style={{ color: '#0056b3', marginBottom: '15px', textAlign: 'center' }}>
